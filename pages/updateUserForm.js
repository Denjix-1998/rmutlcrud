...
export default function UpdateUserForm({ formId, formData, setFormData }) {
  ...
  const { data, isLoading, isError, error } = useQuery(["users", formId], () =>
    getUser(formId)
  );
      ...
      <div className="flex gap-10 items-center ">
        <div className="form-check">
          <input
            ...
            name="status"
            className="form-check-input  appearance-none rounded-full h-4 w-4 border border-gray-300 bg-white  checked:bg-green-500 checked:border-gray-500 focus:outline-none transition duration-200 mt-1 align-top bg-no-repeat bg-contain float-left mr-2 cursor-pointer"
          />
